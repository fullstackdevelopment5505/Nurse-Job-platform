      ...
      const filterBtn = () =>{
        ...
        tempArr = tempArr.filter(sub=>{
            ...
            if(obj['subText'] && sub.title.indexOf(obj['subText'])=== -1)
                return false;
            if(filterCategory !== 'All Category' && sub.category !== filterCategory)
                return false;
            if(filterRangeBudget[1] * 100 < sub.minBudget && filterRangeBudget[0]*100 > sub.maxBudget)
                return false;
            if(props.user){
                                    ...
                                    <div className="job-information">
                                        ...
                                        <div className="job-employer-info-wrapper">
                                            ...
                                            <div className="job-salary">
                                                $<span className="price-text">{row.minBudget}</span> ~  $<span className="price-text">{row.maxBudget}</span> 
                                            </div>    
