...
const EnhancedTableToolbar = props => {
  ...
  function handleMultiRemoveClick(){
    enableLoading();
    setTimeout(() => {
      actions.deleteClients(selected)
        .then(res => {
          disableLoading();
          let {data} = res;
        ...
        {numSelected > 0 ? (
          ...
          <Tooltip title="Add Client">
            {/* <IconButton aria-label="AddCircleOutlineIcon" onClick={handleAddClick}>
             ...
             <Link to="/admin/client/create_edit"><IconButton aria-label="AddCircleOutlineIcon" onClick={handleAddClick}>
              <AddCircleOutlineIcon />
            </IconButton></Link>
          </Tooltip>
        )}
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                          <Link to='/admin/client/create_edit'onClick={()=>handleEditClick(row)}><IconButton aria-label="EditIcon"  style={{paddingTop:0,paddingBottom:0}}>
                            <EditIcon />
                          </IconButton> </Link>
